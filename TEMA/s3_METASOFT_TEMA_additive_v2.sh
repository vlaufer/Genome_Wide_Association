...
SPLIT_DIR="/data/scratch/vlaufer/Joint_Analysis/scripts/METASOFT_TEMA/Code/intermediate_files/RA_TEMA/aligned_grouped"
F_NAMES="${CUR_DIR}/reference_files/merge_files.txt"


# cat ${F_NAMES}
STUDY_NAME="METASOFT_TEMA"                #### Specify the name of your study. Should begin with letter, not number.
...
-mvalue -mvalue_p_thres 1E-4 \
-binary_effects -binary_effects_p_thres 1E-4
